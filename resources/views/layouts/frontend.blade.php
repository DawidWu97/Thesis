...
<script>
    $(document).ready(function () {
        $('.notifications-menu').on('click', function () {
            ...
            $.ajax({
                type:'PATCH',
                url: '{{ route("frontend.user-alerts.read") }}'
            })
...
<script>
    $(document).ready(function() {
        ...
        $('.searchable-field').select2({
            ...
            //theme: "flat",
            ajax: {
                url: '{{ route("frontend.globalSearch") }}',
                dataType: 'json',
                type: 'GET',
                delay: 200,
                data: function (term) {
            ...
            placeholder : 'Wyszukaj warsztat samochodowy...',
            language: {
        ...
        function formatItem (item) {
            ...
            markup += "<div class='searchable-title'><img src='" + item.photo +"' width='100%' height='auto'></div>";
        ...
        function formatItemSelection (item) {
            if (!item.model) {
                return 'Wyszukaj warsztat samochodowy...';
            }
            return item.model;
        }

            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ trans('cruds.part.title') }} {{ trans('global.list') }}
                    </div>
                            ...
                            <table class=" table table-bordered table-striped table-hover datatable datatable-Part">
                                ...
                                @foreach($parts as $key => $part)
                                    <tr data-entry-id="{{ $part->id }}">
                                        <td>
                                            {{ Illuminate\Support\Facades\DB::table('cars')->where('id', $part->task->repair->car_id)->value('brand') ?? '' }}
                                        </td>
                                        <td>
                                            {{ Illuminate\Support\Facades\DB::table('cars')->where('id', $part->task->repair->car_id)->value('model') ?? '' }}
                                        </td>
                                        <td>
                                            {{ Illuminate\Support\Facades\DB::table('cars')->where('id', $part->task->repair->car_id)->value('engine') ?? '' }}
                                        </td>
                                        <td>
                                            {{ $part->name ?? '' }}
                                        </td>

        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if(auth()->user()->id == old('user_id', $serviceStation->user_id))
                        <form method="POST" action="{{ route("frontend.service-stations.update", [$serviceStation->id]) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label class="required" for="name">{{ trans('cruds.serviceStation.fields.name') }}</label>
                                <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $serviceStation->name) }}" required>
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $serviceStation->phone) }}" required>
                                @if($errors->has('phone'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('phone') }}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <input class="form-control timepicker" type="text" name="opening" id="opening" value="{{ old('opening', $serviceStation->opening) }}" required>
                                ...
                                <input class="form-control timepicker" type="text" name="closing" id="closing" value="{{ old('closing', $serviceStation->closing) }}" required>
                                ...
                                <input class="form-control" type="number" name="workplaces" id="workplaces" value="{{ old('workplaces', $serviceStation->workplaces) }}" step="1" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $serviceStation->city) }}" required>
                                @if($errors->has('city'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('city') }}
                                    </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" type="text" name="street" id="street" value="{{ old('street', $serviceStation->street) }}" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" type="text" name="postcode" id="postcode" value="{{ old('postcode', $serviceStation->postcode) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $serviceStation->description) !!}</textarea>

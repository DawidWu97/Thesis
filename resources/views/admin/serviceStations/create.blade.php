        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.service-stations.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control timepicker {{ $errors->has('opening') ? 'is-invalid' : '' }}" type="text" name="opening" id="opening" value="{{ old('opening') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control timepicker {{ $errors->has('closing') ? 'is-invalid' : '' }}" type="text" name="closing" id="closing" value="{{ old('closing') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('workplaces') ? 'is-invalid' : '' }}" type="number" name="workplaces" id="workplaces" value="{{ old('workplaces', '') }}" step="1" required>

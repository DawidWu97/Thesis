        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.repairs.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('customer_comments') ? 'is-invalid' : '' }}" name="customer_comments" id="customer_comments">{!! old('customer_comments') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mileage') ? 'is-invalid' : '' }}" type="number" name="mileage" id="mileage" value="{{ old('mileage', '') }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('calculated_finish') ? 'is-invalid' : '' }}" type="text" name="calculated_finish" id="calculated_finish" value="{{ old('calculated_finish') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('finished_at') ? 'is-invalid' : '' }}" type="text" name="finished_at" id="finished_at" value="{{ old('finished_at') }}">

        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.cars.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('vin') ? 'is-invalid' : '' }}" type="text" name="vin" id="vin" value="{{ old('vin', '') }}" required>
                    @if($errors->has('vin'))
                        <div class="invalid-feedback">
                            {{ $errors->first('vin') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('bought_mileage') ? 'is-invalid' : '' }}" type="number" name="bought_mileage" id="bought_mileage" value="{{ old('bought_mileage', '') }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('bought_at') ? 'is-invalid' : '' }}" type="text" name="bought_at" id="bought_at" value="{{ old('bought_at') }}" required>

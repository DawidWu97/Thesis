...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.upcomings.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mileage') ? 'is-invalid' : '' }}" type="number" name="mileage" id="mileage" value="{{ old('mileage', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('repair_at') ? 'is-invalid' : '' }}" type="text" name="repair_at" id="repair_at" value="{{ old('repair_at') }}" required>

...
class UpcomingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.upcomings.index', compact('upcomings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.upcomings.create', compact('cars'));
    }
    ...
    public function store(StoreUpcomingRequest $request)
    {
        ...
        return redirect()->route('frontend.upcomings.index');
    }
    ...
    public function edit(Upcoming $upcoming)
    {
        ...
        return view('frontend.upcomings.edit', compact('cars', 'upcoming'));
    }
    ...
    public function show(Upcoming $upcoming)
    {
        ...
        return view('frontend.upcomings.show', compact('upcoming'));
    }
